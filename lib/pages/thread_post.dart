      ...
      key: _scaffoldKey,
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            ...
            IconButton(icon: Icon(Icons.send,color: Colors.blue,),

                onPressed: (){

              if(textBodyController.text.length <5){

              final snackbar =  SnackBar(content: Text("Message body too short"),duration: Duration(milliseconds: 500),);
...
//                        child: Padding(
//                          padding: const EdgeInsets.all(8.0),
//                          child: Image(image: AssetImage("assets/google.png"),width: 70,height: 50,),
//                        )
//
//                      ),
//                    );
